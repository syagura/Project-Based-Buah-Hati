 ...
 * Use the [InputPertumbuhanFragment.newInstance] factory method to
...
class InputPertumbuhanFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment InputPertumbuhanFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InputPertumbuhanFragment().apply {
